                ...
                <View style={{flex:1.2,justifyContent:'space-around'}}>
                    <View style={{flex:1,flexDirection:'column',justifyContent:'center'}}>
                        <Text style={{textAlign:'center',fontSize:22,fontWeight:'700',color:Colors.primary,letterSpacing:1}}>FATAFAT 
                            <Text style={{fontWeight:'100',fontFamily:Fonts.fontFamily.helvetica.bold}}>GAMEPLAY</Text>
                        </Text>
                        <Text 
                    ...
                    <View style={{flex:1,justifyContent:'flex-start',flexDirection:'column'}}>
                        ...
                        />
                        {/* <Text style={{fontWeight:'100',fontFamily:Fonts.fontFamily.helvetica.light}}>GAMEPLAY</Text>
                        <Text style={{fontWeight:'100',fontFamily:Fonts.fontFamily.helvetica.normal}}>GAMEPLAY</Text>
                        <Text style={{fontWeight:'100',fontFamily:Fonts.fontFamily.helvetica.medium}}>GAMEPLAY</Text>
                        <Text style={{fontWeight:'100',fontFamily:Fonts.fontFamily.helvetica.bold}}>GAMEPLAY</Text> */}
                    </View>
                </View>
            </View>
